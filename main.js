...
var CLIENT_APPS = [
    ...
    },
    {
        ...
        launchUrl: 'https://iam-integration.us-east.philips-healthsuite.com/authorize/oidc/login?api-version=1&provider=azuredev&client_id=swethaclient&redirect_uri=https://www.philips.com&response_type=code',
        scopes: 'launch/patient,offline_access,openid,patient/*.*,profile,fhirUser',
        standalonePatient: true,
        ehrLaunch: true,
        server: 'logica',
...
module.exports = __webpack_require__(/*! /Users/krupashankar/EHR/ng-smart-on-fhir/src/main.ts */"./src/main.ts");
